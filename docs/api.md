...
roles, and disband the group. Keep the admin set small; do not map softer
...
| POST | `/groups/:id/state/withdraw` | `x0x group disband` | Disband group with a terminal withdrawal commit (admin+) |
